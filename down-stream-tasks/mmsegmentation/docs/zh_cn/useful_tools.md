...
```shell
python tools/publish_model.py work_dirs/pspnet_emo/latest.pth psp_r50_hszhao_200ep.pth
```
...
- 导出 PSPNet 在 cityscapes 数据集上的 pytorch 模型
  ...
  ```shell
  python tools/pytorch2torchscript.py configs/pspnet_emo/pspnet_r50-d8_512x1024_40k_cityscapes.py \
