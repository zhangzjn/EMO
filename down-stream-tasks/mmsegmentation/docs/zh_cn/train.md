...
sh tools/dist_train.sh configs/pspnet_emo/pspnet_r50-d8_512x512_80k_ade20k.py 8 --work_dir work_dirs/pspnet_r50-d8_512x512_80k_ade20k/ --deterministic
```
...
```shell
GPUS=16 sh tools/slurm_train.sh dev pspr50 configs/pspnet_emo/pspnet_r50-d8_512x1024_40k_cityscapes.py work_dirs/pspnet_r50-d8_512x1024_40k_cityscapes/
```
